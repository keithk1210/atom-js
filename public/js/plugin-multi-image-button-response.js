var jsPsychMutliImageButtonResponse = (function (jspsych) {
  'use strict';

  var _package = {
    name: "@jspsych/plugin-multi-image-button-response",
    version: "2.0.0",
    ...
    repository: {
      ...
      directory: "packages/plugin-multi-image-button-response"
    },
    ...
    homepage: "https://www.jspsych.org/latest/plugins/multi-image-button-response",
    peerDependencies: {
      jspsych: ">=7.1.0"
    },
    devDependencies: {
  ...
  class ImageButtonResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      stimulusElement.id = "jspsych-multi-image-button-response-stimulus";
      display_element.appendChild(stimulusElement);
      const buttonGroupElement = document.createElement("div");
      buttonGroupElement.id = "jspsych-multi-image-button-response-btngroup";
      ...
      function after_response(choice) {
        ...
        if (choice == trial.stimulus.length) {
          ...
          if (document.getElementById("jspsych-multi-image-button-response-endbtngrp") == null) {
      ...
      function enable_buttons() {
        var btns = document.querySelectorAll(".jspsych-multi-image-button-response-button button");
      ...
      if (data.rt !== null) {
        this.jsPsych.pluginAPI.clickTarget(
          display_element.querySelector(
            `#jspsych-multi-image-button-response-btngroup [data-choice="${data.response}"]`
          ),
          data.rt
        );
      }
